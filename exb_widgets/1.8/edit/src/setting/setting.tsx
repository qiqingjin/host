...
> {
  ...
  render () {
    const { showLayerPanel, changeModeConfirmOpen } = this.state
    ...
    return (
      <div css={this.getStyle(theme)}>
        <div className='widget-setting-edit'>
          {
          ...
          {itemsLength === 0 && !showLayerPanel &&
            <div className='w-100 text-center edit-blank-placeholder'>
              <div className="position-absolute w-100">
                <ClickOutlined size={48} className='placeholder-icon'/>
                <p>
                  {this.formatMessage('editBlankStatus', {
