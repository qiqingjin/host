...
import { InitResizeHandler } from '../widget'
...
interface EditorProps extends Omit<EditorPlaceholderProps, 'modules' | 'plugin' | 'editorRef'> {
  widgetId: string
  onInitResizeHandler?: InitResizeHandler
...
export const usePlugin = (widgetId: string, useDataSources: ImmutableArray<UseDataSource>, onInitResizeHandler: InitResizeHandler): RenderPlugin => {
