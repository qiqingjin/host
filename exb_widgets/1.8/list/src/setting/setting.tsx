...
> {
  ...
  componentDidMount () {
    ...
    this.setAriaDescribedbyOfSetDataButton()
  }
  ...
  getTemplateSize = () => {
    ...
    const templateSize = {
      STYLE0: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE1: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE2: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE3: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE4: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE5: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE6: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE7: { width: (columnRowTemplateWidth * 100) / viewportWidth, height: (columnRowTemplateHeight * 100) / viewportHeight },
      STYLE8: { width: 65400 / viewportWidth, height: 33500 / viewportHeight },
      STYLE9: { width: 41500 / viewportWidth, height: 41400 / viewportHeight }
    }
    return templateSize
  }
    ...
    return (
      <div ref={ref => { this.setTemplatesContain(ref) }}>
        <SettingSection title={this.formatMessage('chooseTemplateTip')}>
          ...
          <SettingRow>
            <div className='style-group w-100'>
              <Button title={this.formatMessage('emptyTemplateCheckboxString')} className='d-flex w-100' type='tertiary' style={{ paddingLeft: 0, paddingRight: 0 }} onClick={() => { this.handleCheckEmptyTemplateChange() }}>
                <Checkbox
  ...
  renderDataSetting = () => {
    ...
    return (
      <SettingSection>
        ...
        <SettingRow flow='wrap' label={this.formatMessage('data')} role='group' aria-label={this.formatMessage('data')}>
          {!selectionIsInSelf && (
            <DataSourceSelector
        ...
        {this.state?.datasource && <SettingRow flow='wrap' label={this.formatMessage('noDataMessage')} role='group' aria-label={this.formatMessage('noDataMessage')}>
          <TextInput
            size='sm'
            className='w-100'
        ...
        >
          <SettingRow className="mt-2" flow='wrap' label={this.formatMessage('layout')} role='group' aria-label={this.formatMessage('layout')}>
            <div className='d-flex align-items-center w-100 list-layout-select-con'>
              <Button icon title={this.formatMessage('layoutRow')} active={config?.layoutType === ListLayoutType.Row} onClick={() => { this.handleLayoutChange(ListLayoutType.Row) }} className='flex-sm-grow-1' size='lg'>
                <Icon className='style-img w-100 h-100' icon={require('./assets/row.png')}/>
              </Button>
              <Button icon title={this.formatMessage('layoutColumn')} active={config?.layoutType === ListLayoutType.Column} onClick={() => { this.handleLayoutChange(ListLayoutType.Column) }} className='ml-2 flex-sm-grow-1' size='lg'>
                <Icon className='style-img w-100 h-100' icon={require('./assets/column.png')}/>
              </Button>
              <Button icon title={this.formatMessage('layoutGrid')} active={config?.layoutType === ListLayoutType.GRID} onClick={() => { this.handleLayoutChange(ListLayoutType.GRID) }} className='ml-2 flex-sm-grow-1' size='lg'>
          ...
          {config.pageStyle === PageStyle.Scroll && (
            <SettingRow label={this.formatMessage('scrollBar')} role='group' aria-label={this.formatMessage('scrollBar')}>
          ...
          {config.pageStyle === PageStyle.Scroll && (
            <SettingRow label={this.formatMessage('navigator')} role='group' aria-label={this.formatMessage('navigator')}>
              <div className='d-flex'>
                <Switch
  ...
  renderRowColumnLayoutSetting = () => {
    const { config } = this.props
    const cardSize = this.getCardSizeUnit(this.props)
    const isVertical = config.direction === DirectionType.Vertical || config?.layoutType === ListLayoutType.Row
    return (
      <div className='mt-3'>
        <SettingRow
          flow='wrap'
        ...
        <SettingRow label=''>
          <Button title={this.formatMessage('lockItemRatio')} className='d-flex w-100 align-items-center' type='tertiary' style={{ paddingLeft: 0, paddingRight: 0 }} onClick={() => { this.handleCheckboxChange('lockItemRatio') }}>
            <Checkbox
              className='lock-item-ratio'
    ...
    return (
      <SettingSection>
        <SettingCollapse
          ...
          onRequestClose={this.closeSettingCollapse}
        >
          <SettingRow className="mt-2" label={this.formatMessage('search')} role='group' aria-label={this.formatMessage('search')}>
            <div className='d-flex'>
              <Switch
          ...
          {config.searchOpen && (
            ...
            >
              ...
              <Button title={this.formatMessage('exactMatch')} className='d-flex align-items-center' style={{ marginTop: '10px', paddingLeft: 0, paddingRight: 0 }} type='tertiary' onClick={() => { this.handleCheckboxChange('searchExact') }}>
                <Checkbox
          ...
          <SettingRow label={this.formatMessage('sort')} role='group' aria-label={this.formatMessage('sort')}>
            <div className='d-flex'>
              <Switch
          ...
          <SettingRow label={this.formatMessage('filter')} role='group' aria-label={this.formatMessage('filter')}>
            <div className='d-flex'>
              <Switch
          ...
          {config.cardConfigs[Status.Selected].selectionMode !==
            SelectionModeType.None && (
            <Fragment>
              <SettingRow label={this.formatMessage('showSelection')} role='group' aria-label={this.formatMessage('showSelection')}>
                <Switch
              ...
              <SettingRow label={this.formatMessage('clearSelection')} role='group' aria-label={this.formatMessage('clearSelection')}>
                <Switch
  ...
  setAriaDescribedbyOfSetDataButton = () => {
    const setDataButton = document.getElementsByClassName('ds-selector-button')[0]
    if (setDataButton) {
      setDataButton.setAttribute('aria-describedby', 'list-empty-tip')
    }
  }
