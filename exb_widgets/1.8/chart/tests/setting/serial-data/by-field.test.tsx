...
import { ByFieldData, ByFieldDataProps } from '../../../src/setting/settings/chart/web-chart/data/by-field'
...
describe('<ByFieldData />', () => {
  ...
  describe('work well for empty seies', () => {
    it('should render well', () => {
      ...
      const { getByText, queryBySelector } = render(<ByFieldData type='serial' {...props} />)
