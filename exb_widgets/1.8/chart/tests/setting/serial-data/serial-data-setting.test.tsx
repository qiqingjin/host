...
} from '../../../src/setting/settings/chart/web-chart/data'
...
describe('<SerialDataSetting />', () => {
  ...
  describe('<SerialDataSetting />', () => {
    ...
    it('should render ok', () => {
      ...
      const { getByText } = render(<DataSetting type='serial' {...props} />)
    ...
    it('should clean ui when change category type', () => {
      ...
      const { getByText, queryByText, queryBySelector, getBySelector } = render(<Container type='serial' {...props} />)
    ...
    it('test page size change', () => {
      ...
      const { getByText, getByDisplayValue, getBySelector } = render(<Container type='serial' {...props} />)
