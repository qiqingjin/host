...
import { ByGroupData, ByGroupDataProps } from '../../../src/setting/settings/chart/web-chart/data/by-group'
import { getOutStatisticName } from '../../../src/setting/settings/chart/web-chart/data/by-group/utils'
...
describe('<ByGroupData />', () => {
  ...
  describe('work well for empty seies', () => {
    it('should render well', () => {
      ...
      const { getByText, queryBySelector } = render(<ByGroupData type='serial' {...props} />)
    ...
    it('category field change', () => {
      ...
      const { getByText, getBySelector } = render(<Container type='serial' {...props} />)
  ...
  describe('work well for exist series', () => {
    it('category field change', () => {
      ...
      const series = ColumnTemplate.series as WebChartSeries[]
    ...
    it('normal numeric fields change', () => {
      ...
      const { getByText, queryByText, getBySelector, getAllBySelector } = render(<Container type='serial' {...props} />)
      expect(getBySelector(CategoryFieldSelector)).toHaveTextContent(StringFields[0])
      expect(getByText('SUM')).toBeInTheDocument()
      expect(getByText(NumericFields[0])).toBeInTheDocument()
      expect(getBySelector(SortFieldSelector)).toHaveTextContent(StringFields[0])
    ...
    it('statisticType fields change', () => {
      ...
      const propSeries = ColumnTemplate.series as WebChartSeries[]
      ...
      const { getByText, getAllByText, getBySelector, queryBySelector, getAllBySelector } = render(<Container type='serial' {...props} />)
      expect(getBySelector(CategoryFieldSelector)).toHaveTextContent(StringFields[0])
      expect(getByText('SUM')).toBeInTheDocument()
    ...
    it('order by fields change', () => {
      ...
      const { getByText, getBySelector, getAllBySelector } = render(<Container type='serial' {...props} />)
      expect(getBySelector(CategoryFieldSelector)).toHaveTextContent(StringFields[0])
      expect(getByText('SUM')).toBeInTheDocument()
      expect(getByText(NumericFields[0])).toBeInTheDocument()
      expect(getBySelector(SortFieldSelector)).toHaveTextContent(StringFields[0])
