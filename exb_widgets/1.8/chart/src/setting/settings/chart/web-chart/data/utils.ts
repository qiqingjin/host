import { getDefaultBarChartSeries, getDefaultLineChartSeries, getDefaultPieChartSeries, getDefaultScatterPlotChartSeries } from '../../../../../utils/default'
import { CategoryType, WebChartBarChartSeries, WebChartLineChartSeries, WebChartPieChartSeries, WebChartScatterPlotSeries, WebChartSeries } from '../../../../../config'
import { FeatureLayerQueryParams, Immutable, ImmutableArray, ImmutableObject, StatisticType } from 'jimu-core'
