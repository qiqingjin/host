...
import { ChartDataSource, WebChartPieChartSeries, WebChartSeries } from '../../../../../config'
...
const defaultOutlineColor = getDefaultSeriesOutlineColor('pie')

export const PieSeries = (props: PieSeriesProps): React.ReactElement => {
    ...
    <div className='serial-series w-100'>
      ...
      <SettingRow label={translate('grouping')}>
        <div className='slice-grouping w-50 d-flex justify-content-between'>
          ...
          />
          <ThemeColorPicker title={translate('groupedColor')} aria-label={translate('groupedColor')} className='flex-shrink-0 mr-1' value={sliceGroupingFill.color as any} onChange={handleSliceGroupingColorChange} />
        </div>
      </SettingRow>
