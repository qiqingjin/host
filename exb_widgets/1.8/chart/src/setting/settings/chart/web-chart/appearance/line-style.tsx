...
import { getDefaultAxisColor, getDefaultGridColor, getDefaultLineColor } from '../../../../../utils/default'
 ...
 * @param type
 */
export const getLineElements = (type: ChartType) => {
...
const DefaultLineElements = getLineElements('serial')
