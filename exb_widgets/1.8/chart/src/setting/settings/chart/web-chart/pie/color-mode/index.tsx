...
import { WebChartColoringPatterns } from 'jimu-ui/advanced/chart'
import { CategoryType, ChartDataSource, ColorMatches, ConfigFields, WebChartPieChartSeries, WebChartSeries } from '../../../../../../config'
...
export const ColorMode = (props: ColorModeProps): React.ReactElement => {
  const {
    series: propSeries,
